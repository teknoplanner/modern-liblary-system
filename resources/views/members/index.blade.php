        ...
        <div class="bg-white p-6 rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 space-y-4 hover:border-indigo-100 transition-all group">
            ...
            <div class="pt-4 border-t border-gray-50 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    <a href="/members/{{ $member->id }}/edit" class="text-indigo-600 hover:bg-indigo-50 p-2 rounded-xl transition-colors">
                    ...
                    <button @click="open = true; action = '/members/{{ $member->id }}'; title = '{{ $member->name }}'" 
