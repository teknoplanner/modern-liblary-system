...
<div class="max-w-3xl mx-auto space-y-12 py-10 animate-in fade-in slide-in-from-bottom duration-700">
    <div class="space-y-3">
        ...
        <h1 class="text-4xl font-extrabold tracking-tight text-slate-900 leading-tight">Perbarui <span class="text-cyan-600">Data Buku</span></h1>
        <p class="text-slate-500 font-medium max-w-lg">Modifikasi informasi koleksi buku yang sudah terdaftar dalam sistem.</p>
    </div>

    <form action="/books/{{ $book->id }}" method="POST" class="bg-white p-12 rounded-[3.5rem] shadow-[0_48px_96px_-24px_rgba(0,0,0,0.06)] border border-slate-50 space-y-10 relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 gap-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="space-y-3">
                    <label for="isbn" class="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Nomor ISBN</label>
        ...
        <div class="pt-10 flex flex-col md:flex-row items-center justify-end gap-6 border-t border-slate-50">
            <a href="/books" class="text-xs font-black text-slate-400 uppercase tracking-[0.2em] hover:text-rose-500 transition-colors">Batalkan Perubahan</a>
