...
<div x-data="{ open: false, action: '', title: '' }" class="space-y-12 animate-in fade-in slide-in-from-bottom duration-700">
        ...
        <div class="bg-white p-8 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.04)] border border-slate-50 hover:border-cyan-100 transition-all group relative overflow-hidden">
            ...
            <div class="flex items-center gap-5 relative z-10">
                ...
                <div class="flex flex-col">
                    <h3 class="font-extrabold text-slate-900 text-lg leading-tight group-hover:text-cyan-700 transition-colors"><?php echo e($member->name); ?></h3>
                    <span class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mt-0.5"><?php echo e($member->email); ?></span>
                </div>
            </div>
            
            <div class="pt-6 mt-6 border-t border-slate-50 flex items-center justify-between relative z-10">
                <div class="flex items-center gap-3">
                    <a href="/members/<?php echo e($member->id); ?>/edit" class="flex items-center justify-center p-3 bg-cyan-50 text-cyan-600 rounded-2xl hover:bg-cyan-600 hover:text-white transition-all shadow-sm">
                ...
                <div class="flex flex-col items-end">
                    ...
                    <span class="font-mono text-xs font-bold text-slate-300">#<?php echo e(str_pad($member->id, 5, '0', STR_PAD_LEFT)); ?></span>
                </div>
            </div>
    ...
    <div x-show="open" 
        ...
        <div @click.away="open = false" 
            ...
            <div class="space-y-3">
                <h2 class="text-3xl font-black text-slate-900 tracking-tight">Hapus Anggota?</h2>
                <p class="text-slate-400 text-sm font-medium leading-relaxed">Anda yakin ingin menghapus <span class="text-slate-900 font-bold" x-text="title"></span>? Tindakan ini akan menghapus riwayat peminjaman terkait.</p>
            </div>
