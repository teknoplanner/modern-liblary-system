                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        <td class="px-8 py-4">
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-900 group-hover:text-indigo-600 transition-colors"><?php echo e($loan->book->title); ?></span>
                                <span class="text-xs text-gray-400"><?php echo e($loan->book->isbn); ?></span>
                            </div>
                        </td>
                        <td class="px-8 py-4">
                            <div class="flex flex-col">
                                <span class="font-semibold text-gray-700"><?php echo e($loan->member->name); ?></span>
                                <span class="text-xs text-info"><?php echo e($loan->member->email); ?></span>
                            </div>
                        </td>
                        <td class="px-8 py-4">
                            <div class="flex flex-col">
                                <span class="text-gray-600 font-medium"><?php echo e(\Carbon\Carbon::parse($loan->loan_date)->toFormattedDateString()); ?></span>
                                <?php if($loan->return_date): ?>
                                    <span class="text-[10px] text-emerald-500 font-bold uppercase tracking-widest mt-0.5">Returned <?php echo e(\Carbon\Carbon::parse($loan->return_date)->toFormattedDateString()); ?></span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-8 py-4">
                        ...
                        <td class="px-8 py-4 text-right flex items-center justify-end gap-2">
                            ...
                            <?php endif; ?>
                            <button @click="open = true; action = '/loans/<?php echo e($loan->id); ?>'; title = '<?php echo e($loan->book->title); ?> for <?php echo e($loan->member->name); ?>'" 
