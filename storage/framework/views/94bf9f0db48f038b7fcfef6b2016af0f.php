    ...
    <form action="/loans" method="POST" class="bg-white p-8 rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="space-y-2">
                ...
                <select name="book_id" id="book_id" required
                    ...
                    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($book->id); ?>"><?php echo e($book->title); ?> (Stock: <?php echo e($book->stock); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div class="space-y-2">
                ...
                <input type="date" name="loan_date" id="loan_date" required value="<?php echo e(date('Y-m-d')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/infrastruktur/Documents/RPL/Project/sample/resources/views/loans/create.blade.php ENDPATH**/ ?>