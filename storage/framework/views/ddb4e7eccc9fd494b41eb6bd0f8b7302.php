...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Manajemen'); ?> | LuminaLib</title>
    ...
    <div class="min-h-screen flex flex-col">
                ...
                <div class="flex items-center gap-6">
                    <?php if(auth()->guard()->check()): ?>
                        <div class="hidden sm:flex flex-col items-end">
                            ...
                            <span class="text-sm font-bold text-slate-800 leading-tight"><?php echo e(auth()->user()->name); ?></span>
                        </div>
        ...
        <main class="flex-grow py-12 px-6 md:px-12 max-w-7xl mx-auto w-full">
            <?php if(session('success')): ?>
                <div class="mb-8 bg-emerald-50 border border-emerald-100 text-emerald-700 px-6 py-4 rounded-3xl flex items-center gap-4 animate-in fade-in slide-in-from-top duration-500 shadow-sm">
                    ...
                    <span class="font-bold text-sm tracking-tight"><?php echo e(session('success')); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php if(session('error')): ?>
                <div class="mb-8 bg-rose-50 border border-rose-100 text-rose-700 px-6 py-4 rounded-3xl flex items-center gap-4 animate-in fade-in slide-in-from-top duration-500 shadow-sm">
                    ...
                    <span class="font-bold text-sm tracking-tight"><?php echo e(session('error')); ?></span>
                </div>
            <?php endif; ?>
        ...
        <footer class="bg-white border-t border-slate-100 py-12 px-6 text-center">
            <div class="max-w-7xl mx-auto flex flex-col items-center gap-4">
                ...
                <p class="text-slate-400 text-sm font-medium">&copy; <?php echo e(date('Y')); ?> Sistem Perpustakaan LuminaLib. Dikelola dengan Integritas.</p>
            </div>
        </footer>
    </div>
...
<?php /**PATH /Users/infrastruktur/Documents/RPL/Project/sample/resources/views/layouts/app.blade.php ENDPATH**/ ?>