            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50 text-sm">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-8 py-4 font-bold text-gray-900"><?php echo e($book->title); ?></td>
                        <td class="px-8 py-4 text-gray-500 font-mono text-xs"><?php echo e($book->isbn); ?></td>
                        <td class="px-8 py-4 text-center">
                            <?php if($book->stock <= 0): ?>
                                <span class="px-2 py-1 bg-rose-50 text-rose-600 rounded-lg font-bold text-xs ring-1 ring-rose-100">Out of Stock</span>
                            <?php else: ?>
                                <span class="font-black text-indigo-600"><?php echo e($book->stock); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="px-8 py-4 flex items-center gap-2">
                            <a href="/books/<?php echo e($book->id); ?>/edit" class="text-indigo-600 hover:text-indigo-900 font-bold p-2 bg-indigo-50 rounded-lg transition-colors">
