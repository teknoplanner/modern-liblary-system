...
<div x-data="{ open: false, action: '', title: '' }" class="space-y-10 animate-in fade-in slide-in-from-bottom duration-700">
    <!-- Header Section -->
                    ...
                    <tr class="hover:bg-slate-50/30 transition-all group">
                        <td class="px-10 py-6">
                            <div class="flex flex-col">
                                <span class="font-extrabold text-slate-900 text-lg leading-tight group-hover:text-cyan-700 transition-colors"><?php echo e($book->title); ?></span>
                                <span class="text-[10px] font-bold text-slate-300 uppercase tracking-widest mt-1">Literatur Terverifikasi</span>
                            </div>
                        </td>
                        <td class="px-10 py-6 font-mono text-[11px] text-slate-400 font-bold uppercase tracking-tighter"><?php echo e($book->isbn); ?></td>
                        <td class="px-10 py-6 text-center">
                            ...
                            <?php else: ?>
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    <span class="font-black text-slate-900 text-base"><?php echo e($book->stock); ?></span>
                                </div>
                            <?php endif; ?>
                        </td>
                        <td class="px-10 py-6">
                            <div class="flex items-center justify-end gap-3 transition-all duration-300">
                                <a href="/books/<?php echo e($book->id); ?>/edit" class="flex items-center justify-center p-3 bg-cyan-50 text-cyan-600 rounded-2xl hover:bg-cyan-600 hover:text-white transition-all shadow-sm">
                                ...
                                <button @click="open = true; action = '/books/<?php echo e($book->id); ?>'; title = '<?php echo e($book->title); ?>'" 
    ...
    <div x-show="open" 
        ...
        <div @click.away="open = false" 
            ...
            <div class="space-y-3">
                <h2 class="text-3xl font-black text-slate-900 tracking-tight">Hapus Buku?</h2>
                <p class="text-slate-400 text-sm font-medium leading-relaxed">Anda akan menghapus data <span class="text-slate-900 font-bold" x-text="title"></span>. Tindakan ini bersifat permanen.</p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/infrastruktur/Documents/RPL/Project/sample/resources/views/books/index.blade.php ENDPATH**/ ?>